...
document.addEventListener(
    ...
    () => {
        ...
        else console.log("This is Jack, create a mousemove() function to trigger when the mouse is moved")
    },
    false
);
document.addEventListener(
    ...
    () => {
        ...
        else console.log("This is Jack, create a click() function to trigger when clicked")
    },
    false
);
